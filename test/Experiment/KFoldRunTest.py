...
class KFoldRunTest(ClassifierTest):
    ...
    def test_Execute(self):
        ...
        self.assertAlmostEqual(7.33, 100 * experimentPerformance.meanPerformance().getErrorRate(), 2)
        experimentPerformance = kFoldRun.execute(Experiment(C45(), C45Parameter(1, True, 0.2), self.tictactoe))
        self.assertAlmostEqual(15.33, 100 * experimentPerformance.meanPerformance().getErrorRate(), 2)
        ...
        self.assertAlmostEqual(31.84, 100 * experimentPerformance.meanPerformance().getErrorRate(), 2)
        experimentPerformance = kFoldRun.execute(Experiment(Lda(), Parameter(1), self.dermatology))
        self.assertAlmostEqual(2.46, 100 * experimentPerformance.meanPerformance().getErrorRate(), 2)
        ...
        self.assertAlmostEqual(2.67, 100 * experimentPerformance.meanPerformance().getErrorRate(), 2)
        ...
        self.assertAlmostEqual(4.11, 100 * experimentPerformance.meanPerformance().getErrorRate(), 2)
        ...
        self.assertAlmostEqual(3.34, 100 * experimentPerformance.meanPerformance().getErrorRate(), 2)
        experimentPerformance = kFoldRun.execute(Experiment(Bagging(), BaggingParameter(1, 50), self.car))
        self.assertAlmostEqual(5.96, 100 * experimentPerformance.meanPerformance().getErrorRate(), 2)
        ...
        self.assertAlmostEqual(77.33, 100 * experimentPerformance.meanPerformance().getErrorRate(), 2)
