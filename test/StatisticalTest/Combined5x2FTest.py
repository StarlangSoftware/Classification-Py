...
class Combined5x2FTest(ClassifierTest):
    ...
    def test_Compare(self):
        ...
        self.assertAlmostEqual(0.234, combined5x2F.compare(experimentPerformance1, experimentPerformance2).getPValue(), 3)
        ...
        self.assertAlmostEqual(0.03442, combined5x2F.compare(experimentPerformance1, experimentPerformance2).getPValue(), 5)
        ...
        self.assertAlmostEqual(0.3364, combined5x2F.compare(experimentPerformance1, experimentPerformance2).getPValue(), 4)
