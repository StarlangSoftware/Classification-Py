...
class Paired5x2tTest(ClassifierTest):
    ...
    def test_Compare(self):
        ...
        self.assertAlmostEqual(0.317, paired5x2t.compare(experimentPerformance1, experimentPerformance2).getPValue(), 3)
        ...
        self.assertAlmostEqual(0.1208193, paired5x2t.compare(experimentPerformance1, experimentPerformance2).getPValue(), 7)
