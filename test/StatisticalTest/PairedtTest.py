...
class PairedtTest(ClassifierTest):
    ...
    def test_Compare(self):
        ...
        self.assertAlmostEqual(0.217, pairedt.compare(experimentPerformance1, experimentPerformance2).getPValue(), 3)
        ...
        self.assertAlmostEqual(0.0000813, pairedt.compare(experimentPerformance1, experimentPerformance2).getPValue(), 7)
